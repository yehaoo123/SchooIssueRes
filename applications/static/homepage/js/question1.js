$(document).ready(function () {
        ...
        success: function (result) {
            ...
            $(".QuestionPage").append(
                ...
                '                                            关注问题\n' +
                '                                        </button>\n' +
                '                                        <button type="button" disabled="disabled" class="Button Button--blue">\n' +
                ...
                '                                        <button style="margin-right:16px" type="button" disabled="disabled"\n' +
            ...
            $.each(result["answer_list"],function(i,val){
                ...
                var card='                                                    <div class="List-item" tabindex="0">\n' +
                    ...
                    '                                                                    <button type="button"\n' +
                    '                                                                            class="Button ContentItem-action Button--plain Button--withIcon Button--withLabel" disabled="disabled">\n' +
                    ...
                    '                                                                            <button type="button"\n' +
                    '                                                                                    class="Button Button--plain Button--withIcon Button--withLabel" disabled="disabled">\n' +
                    '                                                                                <span style="display: inline-flex; align-items: center;">​<svg\n' +
